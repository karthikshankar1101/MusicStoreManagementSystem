...
void store_data::pack(record r)
{
	...
	strcpy_s(buff, r.id);
	strcat_s(buff, "|");
	strcat_s(buff, r.name);
	strcat_s(buff, "|");
	strcat_s(buff, r.artist);
	strcat_s(buff, "|");
	strcat_s(buff, r.genre);
	strcat_s(buff, "|");
	strcat_s(buff, r.album);
	strcat_s(buff, "|");
	strcat_s(buff, r.price);
	strcat_s(buff, "|");
	strcat_s(buff, r.quantity);
	strcat_s(buff, "|");
	strcat_s(buff, r.nosold);
	strcat_s(buff, "|");
	...
	for (j = 0; j < i; j++)
	{
		if (strcmp(s[j].id, id) == 0)
		{
			...
			if (n > 0 && n <= qu)
			{
				...
				strcpy_s(s[j].quantity, ab);
				strcpy_s(s[j].nosold, cd);
	...
	for (j = 0; j < i; j++)
	{
		if (strcmp(s[j].id, id) == 0)
		{
			...
			if ((strcmp(id1, a)) != 0)
				strcpy_s(s[j].id, id1);
			if ((strcmp(name, a)) != 0)
				strcpy_s(s[j].name, name);
			if ((strcmp(art, a)) != 0)
				strcpy_s(s[j].artist, art);
			if ((strcmp(genre, a)) != 0)
				strcpy_s(s[j].genre, genre);
			if ((strcmp(quan, a)) != 0)
				strcpy_s(s[j].quantity, quan);
			if ((strcmp(album, a)) != 0)
				strcpy_s(s[j].album, album);
			if ((strcmp(price, a)) != 0)
				strcpy_s(s[j].price, price);
			break;
		}
	}
	if (j == i)
